...
function calculateType(lengthBytes) {
  var errorLevel = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'M';
...
var css = ".QrCode_qr__1Gw47 {\n  width: 100%;\n  height: 100%;\n}\n\n.QrCode_qr__1Gw47 img, .QrCode_qr__1Gw47 svg {\n  height: auto !important;\n  max-height: 100%;\n  max-width: 100%;\n  width: auto !important;\n  background: white;\n}\n";
var styles = { "qr": "QrCode_qr__1Gw47" };
__$$styleInject(css);
...
var QrCode = function (_Component) {
  ...
  function QrCode() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = QrCode.__proto__ || Object.getPrototypeOf(QrCode)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      image: null
  ...
  createClass(QrCode, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      var hasChanged = nextProps.value !== this.props.value || nextProps.size !== this.props.size || nextProps.margin !== this.props.margin;
    ...
    key: 'generateCode',
    value: function generateCode(props) {
      var value = props.value;

      var type = calculateType(value.length, QROPTS.ERROR_LEVEL);
      var qr = qrcode_1(0, 'M');
...
var NoVideoInputDevicesError$1 = errors.NoVideoInputDevicesError;
...
function getDeviceId(facingMode) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    try {
      ...
      reject(new NoVideoInputDevicesError$1());
    }
...
var getDeviceId_1 = { getDeviceId: getDeviceId, getFacingModePattern: getFacingModePattern };

var havePropsChanged = function havePropsChanged(prevProps, nextProps, keys) {
  var changedProps = [];
  ...
  RTCPeerConnection.prototype._gather = function(mid, sdpMLineIndex) {
    ...
    iceGatherer.onlocalcandidate = function(evt) {
      ...
      pc.localDescription.sdp =
          sdp.getDescription(pc.localDescription.sdp) +
          sections.join('');
      ...
      if (!pc.remoteDescription) {
        ...
        for (var j = 0; j < pc.transceivers.length; j++) {
          ...
          pc.remoteDescription.sdp =
              sdp.getDescription(pc.remoteDescription.sdp) +
              sections.join('');
          if (pc.usingBundle) {
            break;
          }
...
var edge_shim = {
  ...
  shimPeerConnection: function(window) {
    ...
    window.RTCPeerConnection =
        rtcpeerconnection(window, browserDetails.version);
  },
...
var getDeviceId = getDeviceId_1.getDeviceId,
    getFacingModePattern = getDeviceId_1.getFacingModePattern;
...
module.exports = (_temp = _class = function (_Component) {
  ...
  _createClass(Reader, [{
    ...
    value: function initiate() {
      ...
      var supported = navigator.mediaDevices !== undefined ? navigator.mediaDevices.getSupportedConstraints() : {};
      var constraints = {};
      ...
      var vConstraintsPromise = supported.facingMode || isFirefox ? Promise.resolve(constraints) : getDeviceId(facingMode).then(function (deviceId) {
    ...
    value: function render() {
      ...
      return React__default.createElement(
        ...
        React__default.createElement(
          ...
          !legacyMode && showViewFinder ? React__default.createElement('div', { style: viewFinderStyle }) : null,
          legacyMode ? React__default.createElement('input', {
            style: hiddenStyle,
            type: 'file',
            accept: 'image/*',
          ...
          legacyMode ? React__default.createElement('img', { style: imgPreviewStyle, ref: this.setRefFactory('img'), onLoad: onImageLoad }) : React__default.createElement('video', { style: videoPreviewStyle, ref: this.setRefFactory('preview') }),
          React__default.createElement('canvas', { style: hiddenStyle, ref: this.setRefFactory('canvas') })
        )
      );
    }
  }]);
...
function QrScan(_ref) {
  var onError = _ref.onError,
      onScan = _ref.onScan;

  return React__default.createElement(Reader, {
    delay: SCAN_DELAY,
    onError: onError,
    onScan: onScan,
    style: SCAN_STYLE
...
var QrSigner = function (_Component) {
  inherits(QrSigner, _Component);
  ...
  function QrSigner() {
    ...
    classCallCheck(this, QrSigner);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = QrSigner.__proto__ || Object.getPrototypeOf(QrSigner)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function () {
      _this.setState({ step: SCAN });
    }, _this.handleScan = function (data) {
      if (!data) return;

      if (data.substring(0, 9) === 'ethereum:') {
        // ERC-681 address URL
        var _parseURL = parseURL(data),
            prefix = _parseURL.prefix,
            address = _parseURL.address,
            chainId = _parseURL.chainId;

        if (prefix !== 'pay') {
          throw new Error('Unsupported ERC-831 prefix: ' + prefix);
        }

        _this.props.onScan({ address: address, chainId: chainId });
      } else if (/^[0-9a-fA-F]{40}$/.test(data)) {
        // Legacy address without any prefixes
        _this.props.onScan({ address: '0x' + data, chainId: 1 });
      } else {
        // Signature
  ...
  createClass(QrSigner, [{
    ...
    value: function render() {
      ...
      if (scan) {
        var handleScan = this.handleScan;


        return React__default.createElement(
          'div',
          { style: style },
          React__default.createElement(QrScan, { onScan: handleScan })
        );
      }
      ...
      return React__default.createElement(
        'div',
        { style: style },
        React__default.createElement(QrCode, { value: JSON.stringify(value) })
      );
    }
  }]);
  return QrSigner;
...
QrSigner.defaultProps = {
  size: 250
};

module.exports = QrSigner;
