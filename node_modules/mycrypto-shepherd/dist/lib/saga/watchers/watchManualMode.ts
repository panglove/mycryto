import {  BALANCER,  balancerNetworkSwitchRequested,  IBalancerManualRequested,  setManualFailed,  setManualSucceeded,} from '../../ducks/providerBalancer/balancerConfig';
import { getNetwork } from '../../ducks/providerBalancer/balancerConfig/selectors';
import { getProviderConfigById } from '../../ducks/providerConfigs';
import { AllActions } from '../../ducks/types';
import { checkProviderConnectivity } from '../helpers/connectivity';
