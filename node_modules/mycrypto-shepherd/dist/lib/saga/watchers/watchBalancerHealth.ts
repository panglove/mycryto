import {  BALANCER,  IBalancerAuto,  IBalancerManualSucceeded,  IBalancerNetworkSwitchRequested,  IBalancerNetworkSwitchSucceeded,  setOffline,  setOnline,} from '../../ducks/providerBalancer/balancerConfig';
import { isOffline } from '../../ducks/providerBalancer/balancerConfig/selectors';
import {  PROVIDER_STATS,  ProviderStatsAction,} from '../../ducks/providerBalancer/providerStats';
import { getAllMethodsAvailable } from '../../ducks/selectors';
