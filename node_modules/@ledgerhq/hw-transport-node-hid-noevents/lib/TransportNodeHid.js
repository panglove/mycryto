          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", Promise.resolve(new TransportNodeHidNoEvents(new _nodeHid2.default.HID(path))));
              ...
              case 5:
                return _context.abrupt("return", Promise.resolve(new TransportNodeHidNoEvents(new _nodeHid2.default.HID(device.path))));
