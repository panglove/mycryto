(function (global, factory) {
    ...
    */
        ...
        Formik.prototype.runFieldLevelValidations = function (values) {
            ...
            var fieldKeysWithValidation = Object.keys(this.fields).filter(function (f) {
                return _this.fields &&
                    ...
                    isFunction$1(_this.fields[f].props.validate);
            });
    ...
    var Form = connect(function (_a) {
        var _b = _a.formik, handleReset = _b.handleReset, handleSubmit = _b.handleSubmit, props = __rest(_a, ["formik"]);
        return (React.createElement("form", __assign({ onReset: handleReset, onSubmit: handleSubmit }, props)));
    });
        ...
        return function createFormik(Component) {
            ...
            var C = (function (_super) {
                ...
                C.prototype.render = function () {
                    ...
                    return (React.createElement(Formik, __assign({}, props, config, { validate: config.validate && this.validate, validationSchema: config.validationSchema && this.validationSchema, initialValues: mapPropsToValues(this.props), onSubmit: this.handleSubmit, render: this.renderFormComponent })));
                };
    ...
    var ErrorMessageImpl = (function (_super) {
        ...
        ErrorMessageImpl.prototype.render = function () {
            var _a = this.props, component = _a.component, formik = _a.formik, render = _a.render, children = _a.children, name = _a.name, rest = __rest(_a, ["component", "formik", "render", "children", "name"]);
            var touch = getIn(formik.touched, name);
            var error = getIn(formik.errors, name);
            return !!touch && !!error
                ? render
                    ? isFunction$1(render) ? render(error) : null
                    : children
                        ? isFunction$1(children) ? children(error) : null
                        : component
