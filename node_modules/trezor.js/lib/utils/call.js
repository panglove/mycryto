        ...
        value: function _filterCommonTypes(res) {
            ...
            if (res.type === 'PassphraseRequest') {
                ...
                return this._promptPassphrase().then(function (passphrase) {
                    if (_this3.session.device && _this3.session.device.passphraseState) {
                        return _this3._commonCall('PassphraseAck', { passphrase: passphrase, state: _this3.session.device.passphraseState });
                    }
