...
function signTx(session, inputs, outputs, txs, coin, locktime, overwintered) {
    ...
    if (overwintered) {
        txDesc = _extends({}, txDesc, { overwintered: true, version: 3 });
    }

    return session.typedCall('SignTx', 'TxRequest', txDesc).then(function (res) {
